...
> The version will always be defined in the format **version** = "X.Y.Z" (X, Y, Z are numeric values which can be of different length)
...
You would use this in conjunction with your method of finding the file.
